...
<html xmlns = "http://www.w3.org/1999/xhtml">
    ...
    <header>  
		...
		<div id="form-customerContainer">
			<form id = "productform" action="addcart.php" method = "get">
